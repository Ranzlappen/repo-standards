...
- `.standards-version` bumped from `3.0.5` to `3.1.0` (kept aligned with `VERSION`).
- Root `README.md` standards badge bumped from `v3.0.5` to `v3.1.0`.
- Root `README.md` "Upgrade any repo to vX" headline + body bumped from `v3.0.5` to `v3.1.0`.
- `PROMPT.md` master prompt banner bumped from `repo-standards v3.0.5` → `repo-standards v3.1.0` (line 28).
