...
| [`scripts/dogfood-audit.sh`](./scripts/dogfood-audit.sh) | Self-compliance audit — runs the dogfood invariant checks locally and in CI. PASS / FAIL per assertion, exits non-zero on any FAIL. |
